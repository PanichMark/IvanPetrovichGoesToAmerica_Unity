...
ServiceLocator.Register<PlayerWeaponFirstPersonRenderer>(_weaponFirstPersonRender);
	...
	ServiceLocator.Register(ServiceLocatorGameObjectsEnum.FirstPersonLeftHandWeaponSlotGameObject, _gameObjectFirstPersonLeftHandWeaponSlot);
ServiceLocator.Register(ServiceLocatorGameObjectsEnum.FirstPersonRightHandWeaponSlotGameObject, _gameObjectFirstPersonRightHandWeaponSlot);
ServiceLocator.Register(ServiceLocatorGameObjectsEnum.ThirdPersonLeftHandWeaponSlotGameObject, _gameObjectThirdPersonLeftHandWeaponSlot);
ServiceLocator.Register(ServiceLocatorGameObjectsEnum.ThirdPersonRightHandWeaponSlotGameObject, _gameObjectThirdPersonRightHandWeaponSlot);
