...
public class JsonFileDataHandler
{
	...
	private static readonly JsonSerializerSettings _settings = new JsonSerializerSettings
	{
		...
		Converters = new List<JsonConverter>
		{
            ...
            new JsonFileDataHandler.Vector3Converter(),
			new JsonFileDataHandler.QuaternionConverter()
		},
	...
	public JsonGameData Load()
	{
		...
		try
		{
			...
			return JsonConvert.DeserializeObject<JsonGameData>(dataToLoad, _settings);
		}
		catch (Exception e)
		{
