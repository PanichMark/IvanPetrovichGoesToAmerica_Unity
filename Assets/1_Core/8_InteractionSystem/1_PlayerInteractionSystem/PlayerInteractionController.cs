...
public class PlayerInteractionController : MonoBehaviour, IJsonSaveLoad
{
	...
	private void PickUpPickableObject()
	{
		...
		else
		{
			...
			var pickableRangedWeapon = CurrentPickableObject.GetComponent<InteractionObjectPickableWeaponAbstract>();
