...
public class InteractionObjectLootConsumable : InteractionObjectLootAbstract
{
	...
	protected override void InitializeLootObject()
	{
		...
		{
			InteractionHintMessageAction = _localizationManager.GetLocalizedString("HUD_Interaction_HintMessage_Action_Eat"); 
		}
		else if (_interactionObjectConsumableTypes == InteractionObjectLootConsumableTypes.Drink) 
		{
			InteractionHintMessageAction = _localizationManager.GetLocalizedString("HUD_Interaction_HintMessage_Action_Drink"); 
		}
	}
